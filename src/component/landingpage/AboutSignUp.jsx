    ...
    return (
        <section id="about" className="about">
            ...
            <div id="about-signup" className="about-signup">
                <Button variant="contained" style={{ backgroundColor: '#212d33', color: 'white', marginTop: '10px', marginRight: '10px', width: '25%', height: '7vh' }}>Sign Up</Button>
                <Button variant="contained" style={{ backgroundColor: '#212d33', color: 'white', marginTop: '10px', width: '25%', height: '7vh'  }}>Log In</Button>
            </div>
        </section>
    )
}
